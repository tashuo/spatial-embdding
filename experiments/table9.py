"""Table 9: Binary Join MBR tests - Best results.

Uses AE_C2 (synthetic) and AE_S4 (real) with best DNN and CNN configs.
Predicts MBR tests (SJMR + DJ combined).
...
def run(data_dir, output_dir, **kwargs):
    """Run Table 9 experiment - BJ MBR tests."""
    print("\n" + "=" * 60)
